...
namespace CSharp6.R05
{
    class Programa
    {
        ...
        private static void ImprimirMelhorNota(Aluno aluno)
        {
            ...
            //WriteLine("Melhor nota: {0}", (aluno != null) ? aluno.MelhorAvaliacao.Nota : (double?)null);
            //WriteLine("Melhor nota: {0}", 
            //    (aluno != null) ? 
            //    ((aluno.MelhorAvaliacao != null) ? aluno.MelhorAvaliacao.Nota : (double?)null) : 
            //    (double?)null);
            WriteLine("Melhor nota: {0}", aluno?.MelhorAvaliacao?.Nota);
        }
    }
