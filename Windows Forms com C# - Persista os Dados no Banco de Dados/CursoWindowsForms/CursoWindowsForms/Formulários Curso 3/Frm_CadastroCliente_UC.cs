    ...
    public partial class Frm_CadastroCliente_UC : UserControl
    {
           ...
           if (Txt_Codigo.Text == "")
           ...
           else
            {
                try
                {
                    ...
                    //C = C.BuscarFichario(Txt_Codigo.Text, Directory.GetCurrentDirectory());
        ...
        private void salvarToolStripButton_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                try
                {
                    ...
                    //C.AlterarFichario(Directory.GetCurrentDirectory());
                ...
                try
                {
                    ...
                    else
                    {
                        ...
                        if (Db.DialogResult == DialogResult.Yes)
                        {
                            ...
                            //C.ApagarFichario(Directory.GetCurrentDirectory());
        ...
        private void Btn_Busca_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                //var ListaBusca = C.BuscarFicharioTodos(Directory.GetCurrentDirectory());
                ...
                if (FForm.DialogResult == DialogResult.OK)
                {
                    ...
                    //C = C.BuscarFichario(idSelect, Directory.GetCurrentDirectory());
