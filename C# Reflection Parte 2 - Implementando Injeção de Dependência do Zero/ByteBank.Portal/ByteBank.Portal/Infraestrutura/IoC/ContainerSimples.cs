...
namespace ByteBank.Portal.Infraestrutura.IoC
{
    public class ContainerSimples : IContainer
    {
        ...
        public object Recuperar(Type tipoOrigem)
        {
            ...
            var construtorComParametros = construtores[0];
            var parametrosDoConstrutor = construtorComParametros.GetParameters();
            ...
            var instancia = construtorComParametros.Invoke(valoresDeParametros);
            return instancia;
        }
    }
}
