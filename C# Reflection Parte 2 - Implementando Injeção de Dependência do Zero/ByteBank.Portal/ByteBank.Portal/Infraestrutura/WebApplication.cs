...
{
    public class CartaoTesteContainerService
    {
        ...
        public string ObterCartaoDeDebitoDeDestaque() =>
            "Cartão de Débito de Teste de Container";
    }
    ...
    public class WebApplication
    {
        ...
        private void Configurar()
        {
            ...
            //_container.Registrar(typeof(ICartaoService), typeof(CartaoTesteContainerService));

            //_container.Registrar<ICambioService, CambioTesteService>();
            _container.Registrar<ICartaoService, CartaoTesteService>();
            //_container.Registrar<ICartaoService, CartaoTesteContainerService>();
        }
