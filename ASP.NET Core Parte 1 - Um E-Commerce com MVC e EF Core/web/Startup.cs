...
namespace web
{
    public class Startup
    {
        ...
        {
            // A cada chamada ao método cria-se uma nova instância do serviço
            //services.AddTransient<ICatalogo, Catalogo>();
            //services.AddTransient<IRelatorio, Relatorio>();

            // Cria uma única instância do serviço para cada requisição
            //services.AddScoped<ICatalogo, Catalogo>();
            //services.AddScoped<IRelatorio, Relatorio>();

            // Uma única instância do serviço, independente da requisição
