    ...
    public partial class Frm_Principal_Menu_UC : Form
    {
        ...
        private void Tbc_Aplicacoes_MouseDown(object sender, MouseEventArgs e)
        {
            if (e.Button == MouseButtons.Right)
            {
                ...
                var toolStrip1 = DesenhaItemMenu("Apagar a Aba", "DeleteTab");
                var toolStrip2 = DesenhaItemMenu("Apagar Todas à Esquerda", "DeleteLeft");
                var toolStrip3 = DesenhaItemMenu("Apagar Todas à Direita", "DeleteRight");
                var toolStrip4 = DesenhaItemMenu("Apagar Todas Menos Esta", "DeleteAll");
                toolStrip1.Click += new EventHandler(toolStrip1_Click);
                toolStrip2.Click += new EventHandler(toolStrip2_Click);
                toolStrip3.Click += new EventHandler(toolStrip3_Click);
                toolStrip4.Click += new EventHandler(toolStrip4_Click);
                contextMenuStrip.Items.Add(toolStrip1);
                contextMenuStrip.Items.Add(toolStrip2);
                contextMenuStrip.Items.Add(toolStrip3);
                contextMenuStrip.Items.Add(toolStrip4);
        ...
        private ToolStripMenuItem DesenhaItemMenu(string text, string nomeImagem)
        {
            ...
            toolStripMenuItem.Image = (Image)global::CursoWindowsForms.Properties.Resources.ResourceManager.GetObject(nomeImagem);
